...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "${var.project_prefix}-${var.region}-public-${count.index}"
  }
}
...
resource "aws_route_table" "public" {
  vpc_id = aws_vpc.main.id
  tags = {
    Name = "${var.project_prefix}-${var.region}-rt"
  }
}
...
resource "aws_security_group" "ec2_sg" {
  name        = "${var.project_prefix}-${var.region}-ec2-sg"
...
resource "aws_security_group" "alb_sg" {
  name        = "${var.project_prefix}-${var.region}-alb-sg"
